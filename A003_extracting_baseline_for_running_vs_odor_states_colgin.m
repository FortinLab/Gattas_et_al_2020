...
freq_idx (:,6) = freq>125 & freq<250;

%freq_range_mean_chan = zeros(size(freq_idx,2), length(baseline2{1}(1,:)),chan_counter);
...
save(['baseline_wavelet_32num_20logdb_3hz_250hz_' task '_avg_freq_ODOR_RUN_states'], 'freq_std_chan', 'freq_mean_chan');